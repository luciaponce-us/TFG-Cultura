...
public class AppPropertiesFactory {
	...
	public static AppProperties validAppPropertiesWithJwt(String jwtSecret, long jwtExpiration) {
		...
		return new AppProperties("http://localhost:3000", // frontendUrl
				false, // seedEnabled
				jwt, cloudinary, List.of(Role.COORDINADOR), defaultImages);
	}
	...
	private static AppProperties.Cloudinary cloudinary = new AppProperties.Cloudinary("test-cloud", "test-key",
			"test-secret", false);
