...
public class VideoGameCsvParser extends ItemCsvParser {
    ...
    private VideoGame mapLine(String line, Map<String, Section> sectionsByName, Map<String, Category> categoriesByName) {
        ...
        return builder
                .platform(Platform.valueOf(clean(parts[14])))
                .releaseDate(parseLocalDate(parts[15]))
                .trailerUrl(parseNullableString(parts[16]))
                .build();
    }
