...
public interface SuggestionControllerInterface {
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Sugerencia obtenida correctamente"),
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "201", description = "Sugerencia creada correctamente"),
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Sugerencia modificada correctamente"),
			@ApiResponse(responseCode = "403", description = "Acceso denegado"),
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Sugerencia eliminada correctamente"),
			@ApiResponse(responseCode = "403", description = "Acceso denegado"),
			@ApiResponse(responseCode = "404", description = "Sugerencia o autor no encontrado"),
