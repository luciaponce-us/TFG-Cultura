...
public class SectionController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<SectionResponse> updateSection(@PathVariable String id,
	...
	public ResponseEntity<SectionResponse> removeManagerFromSection(@PathVariable String sectionId,
	...
	public ResponseEntity<SectionResponse> removeCollaboratorFromSection(@PathVariable String sectionId,
	...
	public ResponseEntity<SectionResponse> addManagerToSection(@PathVariable String sectionId,
			@PathVariable String managerUsername) {
	...
	public ResponseEntity<SectionResponse> addCollaboratorToSection(@PathVariable String sectionId,
			@PathVariable String collaboratorUsername) {
