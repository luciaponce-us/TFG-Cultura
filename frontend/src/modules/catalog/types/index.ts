...
export const ITEM_CONDITIONS = ["PERFECT", "MINOR_DAMAGE", "MODERATE_DAMAGE", "SEVERE_DAMAGE"] as const;
...
export const BOOK_TYPES = ["NOVEL", "COMIC", "MANGA", "ENCYCLOPEDIA", "ROL"] as const;
